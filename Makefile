...
bin/fresnel_example: src/fresnel.cc src/fresnel_example.cc src/cmd_options.cc src/cmd_options.hh src/fresnel.hh src/estimate.hh
	g++ src/fresnel.cc src/fresnel_example.cc src/cmd_options.cc -lgsl -lgslcblas -lm -Wall -g -Og -o bin/fresnel_example
